...
DELETE FROM `oc_setting` WHERE `code` = 'revtheme' AND `key` != 'revtheme_license' AND `key` != 'revtheme_license_sh' AND `key` != 'revtheme_license_salt';
...
INSERT INTO `oc_setting` (`setting_id`, `store_id`, `code`, `key`, `value`, `serialized`) VALUES
	...
	('', 0, 'revblog', 'revblog_settings', '{"category_image_width":"80","category_image_height":"80","list_desc_limit":"400","list_image_width":"228","list_image_height":"228","form_image_width":"400","form_image_height":"400","images_image_width":"213","images_image_height":"213","share_status":"1","not_view_null":"1"}', 1);
