		...
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
				...
				if ($this->config->get('admin_quick_edit_activated') == 'activated') {
					...
					if ($this->user->hasPermission('access', 'editors/category')) {					
						$aqmanager[] = array(
							...
							'href'     => $this->url->link('editors/category', 'token=' . $this->session->data['token'], true),
							'children' => array()		
						);
					}
					...
					if ($this->user->hasPermission('access', 'editors/product')) {					
						$aqmanager[] = array(
							...
							'href'     => $this->url->link('editors/product', 'token=' . $this->session->data['token'], true),
							'children' => array()		
						);
					}
					...
					if ($this->user->hasPermission('access', 'editors/filter')) {					
						$aqmanager[] = array(
							...
							'href'     => $this->url->link('editors/filter', 'token=' . $this->session->data['token'], true),
							'children' => array()		
						);
					}
					...
					if ($this->user->hasPermission('access', 'editors/attribute')) {
						$aqmanager_attribute[] = array(
							...
							'href'     => $this->url->link('editors/attribute', 'token=' . $this->session->data['token'], true),
							'children' => array()	
						);
					}
					...
					if ($this->user->hasPermission('access', 'editors/attribute_group')) {
						$aqmanager_attribute[] = array(
							...
							'href'     => $this->url->link('editors/attribute_group', 'token=' . $this->session->data['token'], true),
							'children' => array()		
						);
					}
					...
					if ($this->user->hasPermission('access', 'editors/option')) {					
						$aqmanager[] = array(
							...
							'href'     => $this->url->link('editors/option', 'token=' . $this->session->data['token'], true),
							'children' => array()		
						);
					}
					...
					if ($this->user->hasPermission('access', 'editors/manufacturer')) {					
						$aqmanager[] = array(
							...
							'href'     => $this->url->link('editors/manufacturer', 'token=' . $this->session->data['token'], true),
							'children' => array()		
						);
					}
					...
					if ($this->user->hasPermission('access', 'editors/information')) {					
						$aqmanager[] = array(
							...
							'href'     => $this->url->link('editors/information', 'token=' . $this->session->data['token'], true),
							'children' => array()		
						);
					}
					...
					if ($this->user->hasPermission('access', 'editors/review')) {					
						$aqmanager[] = array(
							...
							'href'     => $this->url->link('editors/review', 'token=' . $this->session->data['token'], true),
							'children' => array()		
						);
					}
					...
					if ($this->user->hasPermission('access', 'editors/customer')) {					
						$aqmanager[] = array(
							...
							'href'     => $this->url->link('editors/customer', 'token=' . $this->session->data['token'], true),
							'children' => array()		
						);
					}
					...
					if ($this->user->hasPermission('access', 'editors/order')) {					
						$aqmanager[] = array(
							...
							'href'     => $this->url->link('editors/order', 'token=' . $this->session->data['token'], true),
							'children' => array()		
						);
					}
					...
					if ($this->user->hasPermission('access', 'tool/seo_manager')) {					
						$aqmanager[] = array(
							...
							'href'     => $this->url->link('tool/seo_manager', 'token=' . $this->session->data['token'], true),
							'children' => array()		
						);
					}
			...
			*/
			...
			if ($this->user->hasPermission('access', 'csvprice_pro/app_product')) {
                ...
                if ($this->user->hasPermission('access', 'extension/vk_export')) {
                    $this->language->load('extension/vk_export_header');
                    $extension[] = array(
                        'name'	   => $this->language->get('text_vk_export'),
                        'href'     => '',
                        'children' => array(
                            array(
                                'name'	   => $this->language->get('text_vk_export'),
                                'href'     => $this->url->link('extension/vk_export', 'token=' . $this->session->data['token'], true),
                                'children' => array()
                            ),
                            array(
                                'name'	   => $this->language->get('text_vk_export_albums'),
                                'href'     => $this->url->link('extension/vk_export/albums', 'token=' . $this->session->data['token'], true),
                                'children' => array()
                            ),
                            array(
                                'name'	   => $this->language->get('text_vk_export_market'),
                                'href'     => $this->url->link('extension/vk_export/market', 'token=' . $this->session->data['token'], true),
                                'children' => array()
                            ),
                            array(
                                'name'	   => $this->language->get('text_vk_export_setting'),
                                'href'     => $this->url->link('extension/module/vk_export', 'token=' . $this->session->data['token'], true),
                                'children' => array()
                            ),
                            array(
                                'name'	   => $this->language->get('text_vk_export_cron_report'),
                                'href'     => $this->url->link('extension/vk_export/report', 'token=' . $this->session->data['token'], true),
                                'children' => array()
                            ),
                        )		
                    );
