<?php
class ModelEditorsAttribute extends Model {
	public function addAttribute($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "attribute SET attribute_group_id = '" . (int)$data['attribute_group_id'] . "', sort_order = '" . (int)$data['sort_order'] . "'");

		$attribute_id = $this->db->getLastId();
		$this->new_attribute_id = $attribute_id;
	...
	public function copyAttribute($attribute_id) {
		$query = $this->db->query("SELECT DISTINCT * FROM " . DB_PREFIX . "attribute a WHERE a.attribute_id = '" . (int)$attribute_id . "'");
		...
		if ($query->num_rows) {
			...
			$data['attribute_description'] = $this->getAttributeDescriptions($attribute_id);

			$this->addAttribute($data);

			return $this->new_attribute_id;
		}
	}
