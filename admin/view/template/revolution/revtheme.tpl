...
ckeditorInit('input-description-contact<?php echo $language['language_id']; ?>', '<?php echo $token; ?>');
ckeditorInit('input-modal-text<?php echo $language['language_id']; ?>', '<?php echo $token; ?>');
<?php } else { ?>
$('#input-description<?php echo $language['language_id']; ?>').summernote({height: 300, lang:'<?php echo $lang; ?>'});
$('#input-description-contact<?php echo $language['language_id']; ?>').summernote({height: 300, lang:'<?php echo $lang; ?>'});
$('#input-modal-text<?php echo $language['language_id']; ?>').summernote({height: 300, lang:'<?php echo $lang; ?>'});
<?php } ?>
<?php } ?>
function apply(){
	$(".alert").remove();
