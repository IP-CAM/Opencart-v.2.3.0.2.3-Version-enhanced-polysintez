	...
	public function index() {
		...
		if (isset($this->request->get['limit'])) {
			...
			if (VERSION >= 2.2) {
				...
				$this->document->setTitle("Новинки каталога интернет-магазина компании ПОЛИСИНТЕЗ");
		$this->document->setdescription("На этой странице представлены новинки товаров, представленных в каталоге нашего интернет-магазина. В нашем интернет-магазине вы можете купить качественный товар по конкурентно низким ценам.");
