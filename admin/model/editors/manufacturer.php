...
class ModelEditorsManufacturer extends Model {
	public function addManufacturer($data) {
		...
		$this->new_manufacturer_id = $manufacturer_id;
	...
	public function copyManufacturer($manufacturer_id) {
		...
		if ($query->num_rows) {
			...
			$data['manufacturer_description'] = $this->getManufacturerDescriptions($manufacturer_id);
			$data['manufacturer_store'] = $this->getManufacturerStores($manufacturer_id);

			$this->addManufacturer($data);

			return $this->new_manufacturer_id;
		}
	}
