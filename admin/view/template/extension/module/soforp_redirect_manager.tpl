...
$widgets = new SoforpWidgets('soforp_redirect_manager_',$params);
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab-general">
							...
							<?php if( !isset($license_error) ) { ?>
								...
								<?php $widgets->dropdown('joomla_status',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
								<?php $widgets->input('joomla_product'); ?>
								<?php $widgets->input('joomla_category'); ?>
								<?php $widgets->dropdown('oscommerce_status',array( 0 => $text_disabled, 1 => $text_enabled)); ?>
