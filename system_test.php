...
?>
	...
	<div align="center">
		<div class="main">
			...
			<center>
				<h2>Тест системы</h2>
				Этот тест проверит будут ли <a href="http://neoseo.com.ua/">модули от neoseo.com.ua</a> работать на вашем сервере.
			...
			<table width="100%">
				...
				<tr>
					<td>
						...
						?>
						<br/>
						<b>Необходимо:</b> 5.3.x.x - 5.6.x.x
						<br/>
						<br/>
					...
					<td>
						...
						if ($ioncube_loader_version_major >= 5) {
			...
			<br/>
			<br/>
			<b>Если какой-то параметр не совпадает, пожалуйста напишите мне на <a href="mailto:support@neoseo.com.ua">support@neoseo.com.ua</a>
