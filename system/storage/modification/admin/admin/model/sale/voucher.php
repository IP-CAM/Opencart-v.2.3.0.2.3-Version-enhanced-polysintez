	...
	public function sendVoucher($voucher_id) {
		...
		if ($voucher_info) {
			...
			if ($order_info) {
                ...
                //Send Mail to Admin
                $this->model_extension_module_shoputils_mail_order_status->voucherAdmin(array('voucher_info' => $voucher_info, 'order_info' => $order_info));
                //Send Mail to Affiliate
                if ($this->model_extension_module_shoputils_mail_order_status->voucher(array('voucher_info' => $voucher_info, 'order_info' => $order_info))) {
                    return;
                }
