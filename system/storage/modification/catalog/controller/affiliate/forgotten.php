	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->model_affiliate_affiliate->editPassword($this->request->post['email'], $password);
                ...
                //Send Mail to Admin
                $this->model_extension_module_shoputils_mail_order_status->affiliateForgottenAdmin(array('password' => $password, 'email' => $this->request->post['email']));
                //Send Mail to Affiliate
                if (!$this->model_extension_module_shoputils_mail_order_status->affiliateForgotten(array('password' => $password, 'email' => $this->request->post['email']))) {
