        ...
        <?php if (!empty($payment_methods)) { ?>
            ...
            <?php } else { ?>
             ...
             ?>
                    ...
                    <?php if (!empty($payment_method['description']) and ((isset($payment_method['show_description']) and (($payment_method['code'] == $code and $payment_method['show_description'] == 1) or $payment_method['show_description'] == 2)) or !isset($payment_method['show_description']))) { ?>
