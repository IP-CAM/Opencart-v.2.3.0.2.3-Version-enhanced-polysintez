...
<div class="modal-body">
  <div class="alert alert-warning"><i class="fa fa-spinner fa-pulse fa-lg fa-fw"></i> <?php echo $text_loading; ?></div>
  <form id="form-order-method" class="form-horizontal">
    <ul id="order" class="nav nav-tabs nav-justified">
      <li class="disabled hidden"><a href="#tab-customer" data-toggle="tab"></a></li>
      <li class="disabled hidden"><a href="#tab-cart" data-toggle="tab"></a></li>
      <li class="disabled hidden"><a href="#tab-payment" data-toggle="tab"></a></li>
      <li class="disabled hidden"><a href="#tab-shipping" data-toggle="tab"></a></li>
      <li class="disabled hidden"><a href="#tab-total" data-toggle="tab"></a></li>
    </ul>
    <div class="tab-content">
      <div class="tab-pane hidden" id="tab-customer">
        ...
        <div class="form-group">
          <?php if (isset($firstname)) { ?>
			...
			<?php } else { ?>
			<input type="text" name="firstname" value="<?php echo $text_not_specified; ?>" id="input-firstname" class="form-control" />
		  <?php } ?>
        </div>
        <div class="form-group">
          <?php if (isset($lastname)) { ?>
			...
			<?php } else { ?>
			<input type="text" name="lastname" value="<?php echo $text_not_specified; ?>" id="input-lastname" class="form-control" />
		  <?php } ?>
        </div>
        <div class="form-group">
          <?php if (isset($email)) { ?>
			...
			<?php } else { ?>
			<input type="text" name="email" value="<?php echo $text_not_specified; ?>" id="input-email" class="form-control" />
		  <?php } ?>
        </div>
        <div class="form-group">
          <?php if (isset($telephone)) { ?>
			...
			<?php } else { ?>
			<input type="text" name="telephone" value="<?php echo $text_not_specified; ?>" id="input-telephone" class="form-control" />
		  <?php } ?>
        </div>
        <div class="form-group">
		  <?php if (isset($fax)) { ?>
			...
			<?php } else { ?>
			<input type="text" name="fax" value="<?php echo $text_not_specified; ?>" id="input-fax" class="form-control" />
		  <?php } ?>
        </div>
        <?php foreach ($custom_fields as $custom_field) { ?>
          <?php if ($custom_field['location'] == 'account') { ?>
            <?php if ($custom_field['type'] == 'select') { ?>
              ...
              <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order'] + 3; ?>">
                <label class="col-sm-2 control-label" for="input-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
                <div class="col-sm-10">
                  <?php if (isset($payment_custom_field[$custom_field['custom_field_id']])) { ?>
				  <input type="text" name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo (isset($account_custom_field[$custom_field['custom_field_id']]) ? $account_custom_field[$custom_field['custom_field_id']] : $custom_field['value']); ?>" placeholder="<?php echo $custom_field['name']; ?>" id="input-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
				  <?php } else { ?>
				  <input type="text" name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $text_not_specified; ?>" placeholder="<?php echo $custom_field['name']; ?>" id="input-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
                  <?php } ?>
				</div>
              </div>
              <?php } ?>
              ...
              <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order'] + 3; ?>">
                ...
                <div class="col-sm-10">
                  ...
                  <?php } else { ?>
				  <textarea name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" rows="5" placeholder="<?php echo $custom_field['name']; ?>" id="input-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control"><?php echo $text_not_specified; ?></textarea>
                  <?php } ?>
				</div>
              </div>
              <?php } ?>
              ...
              <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order'] + 3; ?>">
                <label class="col-sm-2 control-label"><?php echo $custom_field['name']; ?></label>
                <div class="col-sm-10">
                  <button type="button" id="button-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="btn btn-default"><i class="fa fa-upload"></i> <?php echo $Загрузить; ?></button>
                  <?php if (isset($payment_custom_field[$custom_field['custom_field_id']])) { ?>
                  ...
                  <?php } else { ?>
				  <input type="hidden" name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $text_not_specified; ?>" id="input-custom-field<?php echo $custom_field['custom_field_id']; ?>" />
                  <?php } ?>
				</div>
              </div>
              <?php } ?>
              ...
              <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order'] + 3; ?>">
                ...
                <div class="col-sm-10">
                  <div class="input-group date">
                    ...
                    <?php } else { ?>
					<input type="text" name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $text_not_specified; ?>" placeholder="<?php echo $custom_field['name']; ?>" data-date-format="YYYY-MM-DD" id="input-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
                    <?php } ?>
              ...
              <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order'] + 3; ?>">
                ...
                <div class="col-sm-10">
                  <div class="input-group time">
                    ...
                    <?php } else { ?>
					<input type="text" name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $text_not_specified; ?>" placeholder="<?php echo $custom_field['name']; ?>" data-date-format="HH:mm" id="input-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
                    <?php } ?>
					<span class="input-group-btn">
                    <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                    </span></div>
              ...
              <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order'] + 3; ?>">
                ...
                <div class="col-sm-10">
                  <div class="input-group datetime">
                    ...
                    <?php } else { ?>
					<input type="text" name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $text_not_specified; ?>" placeholder="<?php echo $custom_field['name']; ?>" data-date-format="YYYY-MM-DD HH:mm" id="input-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
                    <?php } ?>
					<span class="input-group-btn">
                    <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                    </span></div>
          ...
          <?php } ?>
        <?php } ?>
        <div class="text-right"><button type="button" id="button-customer" class="hidden"></button></div>
      </div>
      <div class="tab-pane hidden" id="tab-cart">
        ...
        <ul class="nav nav-tabs nav-justified">
          <li class="active"><a href="#tab-product" data-toggle="tab"></a></li>
          <li><a href="#tab-voucher" data-toggle="tab"></a></li>
        </ul>
        <div class="tab-content">
          <div class="tab-pane active" id="tab-product">
            ...
            <div class="text-right"><button type="button" id="button-product-add" class="hidden"></button></div>
          </div>
          <div class="tab-pane" id="tab-voucher">
            ...
            <div class="text-right"><button type="button" id="button-voucher-add" class="hidden"></button></div>
          </div>
        </div>
        <button type="button" onclick="$('a[href=\'#tab-customer\']').tab('show');" class="hidden"></button>
        <button type="button" id="button-cart" class="hidden"></button>
      </div>
      <div class="tab-pane hidden" id="tab-payment">
        <div class="form-group">
        ...
        <div class="form-group">
          <?php if (isset($payment_firstname)) { ?>
			<input type="text" name="firstname" value="<?php echo $payment_firstname; ?>" id="input-payment-firstname" class="form-control" />
			<?php } else { ?>
			<input type="text" name="firstname" value="<?php echo $text_not_specified; ?>" id="input-payment-firstname" class="form-control" />
		  <?php } ?>
        </div>
        <div class="form-group">
          <?php if (isset($payment_lastname)) { ?>
			<input type="text" name="lastname" value="<?php echo $payment_lastname; ?>" id="input-payment-lastname" class="form-control" />
			<?php } else { ?>
			<input type="text" name="lastname" value="<?php echo $text_not_specified; ?>" id="input-payment-lastname" class="form-control" />
		  <?php } ?>
        </div>
        <div class="form-group">
          <?php if (isset($payment_company)) { ?>
			<input type="text" name="company" value="<?php echo $payment_company; ?>" id="input-payment-company" class="form-control" />
			<?php } else { ?>
			<input type="text" name="company" value="<?php echo $text_not_specified; ?>" id="input-payment-company" class="form-control" />
		  <?php } ?>
        </div>
        <div class="form-group">
          <?php if (isset($payment_address_1)) { ?>
			<input type="text" name="address_1" value="<?php echo $payment_address_1; ?>" id="input-payment-address-1" class="form-control" />
			<?php } else { ?>
			<input type="text" name="address_1" value="<?php echo $text_not_specified; ?>" id="input-payment-address-1" class="form-control" />
		  <?php } ?>
        </div>
        <div class="form-group">
          <?php if (isset($payment_address_2)) { ?>
			<input type="text" name="address_2" value="<?php echo $payment_address_2; ?>" id="input-payment-address-2" class="form-control" />
			<?php } else { ?>
			<input type="text" name="address_2" value="<?php echo $text_not_specified; ?>" id="input-payment-address-2" class="form-control" />
		  <?php } ?>
        </div>
        <div class="form-group">
          <?php if (isset($payment_city)) { ?>
			<input type="text" name="city" value="<?php echo $payment_city; ?>" id="input-payment-city" class="form-control" />
			<?php } else { ?>
			<input type="text" name="city" value="<?php echo $text_not_specified; ?>" id="input-payment-city" class="form-control" />
		  <?php } ?>
        </div>
        <div class="form-group">
          <?php if (isset($payment_postcode)) { ?>
			<input type="text" name="postcode" value="<?php echo $payment_postcode; ?>" id="input-payment-postcode" class="form-control" />
			<?php } else { ?>
			<input type="text" name="postcode" value="<?php echo $text_not_specified; ?>" id="input-payment-postcode" class="form-control" />
		  <?php } ?>
        </div>
        <div class="form-group">
        ...
        <?php foreach ($custom_fields as $custom_field) { ?>
            ...
            <?php if ($custom_field['type'] == 'select') { ?>
              ...
              <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order'] + 3; ?>">
                ...
                <div class="col-sm-10">
                  ...
                  <?php } else { ?>
				  <input type="text" name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $text_not_specified; ?>" placeholder="<?php echo $custom_field['name']; ?>" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
                  <?php } ?>
				</div>
              </div>
              <?php } ?>
              ...
              <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order'] + 3; ?>">
                ...
                <div class="col-sm-10">
				  ...
				  <?php } else { ?>
				  <textarea name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" rows="5" placeholder="<?php echo $custom_field['name']; ?>" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control"><?php echo $text_not_specified; ?></textarea>
                  <?php } ?>
				</div>
              </div>
              <?php } ?>
              ...
              <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order'] + 3; ?>">
                <label class="col-sm-2 control-label"><?php echo $custom_field['name']; ?></label>
                <div class="col-sm-10">
                  <button type="button" id="button-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" data-loading-text="Загрузка..." class="btn btn-default"><i class="fa fa-upload"></i> <?php echo $Загрузить; ?></button>
                  <?php if (isset($payment_custom_field[$custom_field['custom_field_id']])) { ?>
                  ...
                  <?php } else { ?>
				  <input type="hidden" name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $text_not_specified; ?>" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" />
                  <?php } ?>
				</div>
              </div>
              <?php } ?>
              ...
              <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order'] + 3; ?>">
                ...
                <div class="col-sm-10">
                  <div class="input-group date">
                    ...
                    <?php } else { ?>
					<input type="text" name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $text_not_specified; ?>" placeholder="<?php echo $custom_field['name']; ?>" data-date-format="YYYY-MM-DD" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
					<?php } ?>
					<span class="input-group-btn">
                    <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                    </span></div>
              ...
              <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order'] + 3; ?>">
                ...
                <div class="col-sm-10">
                  <div class="input-group time">
                    ...
                    <?php } else { ?>
					<input type="text" name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $text_not_specified; ?>" placeholder="<?php echo $custom_field['name']; ?>" data-date-format="HH:mm" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
                    <?php } ?>
					<span class="input-group-btn">
                    <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                    </span></div>
              ...
              <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order'] + 3; ?>">
                ...
                <div class="col-sm-10">
                  <div class="input-group datetime">
                    ...
                    <?php } else { ?>
					<input type="text" name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $text_not_specified; ?>" placeholder="<?php echo $custom_field['name']; ?>" data-date-format="YYYY-MM-DD HH:mm" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
                    <?php } ?>
					<span class="input-group-btn">
                    <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                    </span></div>
          ...
          <?php } ?>
        <?php } ?>
        <button type="button" onclick="$('a[href=\'#tab-cart\']').tab('show');" class="hidden"></button>
        <button type="button" id="button-payment-address" class="hidden"></button>
      </div>
      <div class="tab-pane hidden" id="tab-shipping">
        ...
        <div class="form-group">
		  <?php if (isset($shipping_firstname)) { ?>
            <input type="text" name="firstname" value="<?php echo $shipping_firstname; ?>" id="input-shipping-firstname" class="form-control" />
			<?php } else { ?>
			<input type="text" name="firstname" value="<?php echo $text_not_specified; ?>" id="input-shipping-firstname" class="form-control" />
		  <?php } ?>
        </div>
         <div class="form-group">
          <?php if (isset($shipping_lastname)) { ?>
			<input type="text" name="lastname" value="<?php echo $shipping_lastname; ?>" id="input-shipping-lastname" class="form-control" />
			<?php } else { ?>
			<input type="text" name="lastname" value="<?php echo $text_not_specified; ?>" id="input-shipping-lastname" class="form-control" />
		  <?php } ?>
        </div>
        <div class="form-group">
          <?php if (isset($shipping_company)) { ?>
			<input type="text" name="company" value="<?php echo $shipping_company; ?>" id="input-shipping-company" class="form-control" />
			<?php } else { ?>
			<input type="text" name="company" value="<?php echo $text_not_specified; ?>" id="input-shipping-company" class="form-control" />
		  <?php } ?>
        </div>
        <div class="form-group">
          <?php if (isset($shipping_address_1)) { ?>
			<input type="text" name="address_1" value="<?php echo $shipping_address_1; ?>" id="input-shipping-address-1" class="form-control" />
			<?php } else { ?>
			<input type="text" name="address_1" value="<?php echo $text_not_specified; ?>" id="input-shipping-address-1" class="form-control" />
		  <?php } ?>
        </div>
        <div class="form-group">
          <?php if (isset($shipping_address_2)) { ?>
			...
			<?php } else { ?>
			<input type="text" name="address_2" value="<?php echo $text_not_specified; ?>" id="input-shipping-address-2" class="form-control" />
		  <?php } ?>
        </div>
        <div class="form-group required">
          <?php if (isset($shipping_city)) { ?>
			<input type="text" name="city" value="<?php echo $shipping_city; ?>" id="input-shipping-city" class="form-control" />
			<?php } else { ?>
			<input type="text" name="city" value="<?php echo $text_not_specified; ?>" id="input-shipping-city" class="form-control" />
		  <?php } ?>
        </div>
        <div class="form-group">
          <?php if (isset($shipping_postcode)) { ?>
			<input type="text" name="postcode" value="<?php echo $shipping_postcode; ?>" id="input-shipping-postcode" class="form-control" />
			<?php } else { ?>
			<input type="text" name="postcode" value="<?php echo $text_not_specified; ?>" id="input-shipping-postcode" class="form-control" />
		  <?php } ?>
        </div>
        <div class="form-group">
        ...
        <?php foreach ($custom_fields as $custom_field) { ?>
            ...
            <?php if ($custom_field['type'] == 'select') { ?>
              ...
              <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order'] + 3; ?>">
                ...
                <div class="col-sm-10">
                  ...
                  <?php } else { ?>
				  <input type="text" name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $text_not_specified; ?>" placeholder="<?php echo $custom_field['name']; ?>" id="input-shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
                  <?php } ?>
				</div>
              </div>
              <?php } ?>
              ...
              <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order'] + 3; ?>">
                ...
                <div class="col-sm-10">
                  ...
                  <?php } else { ?>
				  <textarea name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" rows="5" placeholder="<?php echo $custom_field['name']; ?>" id="input-shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control"><?php echo $text_not_specified; ?></textarea>
                  <?php } ?>
				</div>
              </div>
              <?php } ?>
              ...
              <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order'] + 3; ?>">
                <label class="col-sm-2 control-label"><?php echo $custom_field['name']; ?></label>
                <div class="col-sm-10">
                  <button type="button" id="button-shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>" data-loading-text="Загрузка" class="btn btn-default"><i class="fa fa-upload"></i> <?php echo $Загрузить; ?></button>
                  <?php if (isset($payment_custom_field[$custom_field['custom_field_id']])) { ?>
              ...
              <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order'] + 3; ?>">
                ...
                <div class="col-sm-10">
                  <div class="input-group date">
                    ...
                    <?php } else { ?>
					<input type="text" name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $text_not_specified; ?>" placeholder="<?php echo $custom_field['name']; ?>" data-date-format="YYYY-MM-DD" id="input-shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
                    <?php } ?>
					<span class="input-group-btn">
                    <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                    </span></div>
              ...
              <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order'] + 3; ?>">
                ...
                <div class="col-sm-10">
                  <div class="input-group time">
                    ...
                    <?php } else { ?>
					<input type="text" name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $text_not_specified; ?>" placeholder="<?php echo $custom_field['name']; ?>" data-date-format="HH:mm" id="input-shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
                    <?php } ?>
					<span class="input-group-btn">
                    <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                    </span></div>
              ...
              <div class="form-group custom-field custom-field<?php echo $custom_field['custom_field_id']; ?>" data-sort="<?php echo $custom_field['sort_order'] + 3; ?>">
                ...
                <div class="col-sm-10">
                  <div class="input-group datetime">
                    ...
                    <?php } else { ?>
					<input type="text" name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" value="<?php echo $text_not_specified; ?>" placeholder="<?php echo $custom_field['name']; ?>" data-date-format="YYYY-MM-DD HH:mm" id="input-shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control" />
                    <?php } ?>
					<span class="input-group-btn">
                    <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                    </span></div>
          ...
          <?php } ?>
        <?php } ?>
        <button type="button" onclick="$('a[href=\'#tab-payment\']').tab('show');" class="hidden"></button>
        <button type="button" id="button-shipping-address" class="hidden"></button>
      </div>
      <div class="tab-pane" id="tab-total">
        <table class="hidden"><tbody id="total"></tbody></table>
        ...
        <div class="hidden">
		  <?php if (isset($coupon)) { ?>
			...
			<?php } else { ?>
			<input type="text" name="coupon" value="<?php echo $text_not_specified; ?>" id="input-coupon" class="form-control" />
		  <?php } ?>
          <button type="button" id="button-coupon" class="hidden"></button>
        </div>
        <div class="hidden">
		  <?php if (isset($voucher)) { ?>
            <input type="text" name="voucher" value="<?php echo $voucher; ?>" id="input-voucher" class="form-control" />
			<?php } else { ?>
			<input type="text" name="voucher" value="<?php echo $text_not_specified; ?>" id="input-voucher" class="form-control" />
		  <?php } ?>
          <button type="button" id="button-voucher" class="hidden"></button>
        </div>
        <div class="hidden">
		  <?php if (isset($reward)) { ?>
            <input type="text" name="reward" value="<?php echo $reward; ?>" id="input-reward" class="form-control" />
			<?php } else { ?>
			<input type="text" name="reward" value="<?php echo $text_not_specified; ?>" id="input-reward" class="form-control" />
		  <?php } ?>
          <button type="button" id="button-reward" class="hidden"></button>
        </div>
        <div class="hidden">
        ...
        <div class="hidden">
          <?php if (isset($reward)) { ?>
			...
			<?php } else { ?>
			<textarea name="comment" rows="5" id="input-comment" class="form-control"><?php echo $text_not_specified; ?></textarea>
		  <?php } ?>
        </div>
        <div class="hidden">
          <?php if (isset($affiliate_id)) { ?>
			...
			<?php } else { ?>
            <input type="text" name="affiliate" value="<?php echo $text_not_specified; ?>" id="input-affiliate" class="form-control" />
...
<div id="modal-footer" class="modal-footer hidden">
  <div class="text-center">
    <button type="button" id="button-refresh" class="hidden"></button>
    <button type="button" id="button-save" class="btn btn-primary"><i class="fa fa-save fa-fw"></i> <?php echo $button_save; ?></button>
  </div>
</div>
		...
		success: function(json) {
			...
			if (json['products'].length) {
				for (i = 0; i < json['products'].length; i++) {
					...
					html += '  <td class="text-right"><div class="input-group btn-block" style="max-width: 200px;"><input type="text" name="product[' + i + '][quantity]" value="' + product['quantity'] + '" class="form-control" /><span class="input-group-btn"><button type="button" data-toggle="tooltip" title="Обновить" data-loading-text="Загрузка..." class="btn btn-primary"><i class="fa fa-refresh"></i></button></span></div></td>';
                    html += '  <td class="text-right">' + product['price'] + '</td>';
					html += '  <td class="text-right">' + product['total'] + '</td>';
					html += '  <td class="text-center" style="width: 3px;"><button type="button" value="' + product['cart_id'] + '" data-toggle="tooltip" title="Удалить" data-loading-text="Загрузка..." class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
					html += '</tr>';
			...
			if (json['vouchers'].length) {
				for (i in json['vouchers']) {
					...
					html += '  <td class="text-right">' + voucher['price'] + '</td>';
					html += '  <td class="text-center" style="width: 3px;"><button type="button" value="' + voucher['code'] + '" data-toggle="tooltip" title="Удалить" data-loading-text="Загрузка..." class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
					html += '</tr>';
				}
			}
		...
		if (item['option'] != '') {
			...
			for (i = 0; i < item['option'].length; i++) {
				...
				if (option['type'] == 'file') {
					...
					html += '  <label class="col-sm-2 control-label">' + option['name'] + '</label>';
					html += '  <div class="col-sm-10">';
					html += '    <button type="button" id="button-upload' + option['product_option_id'] + '" data-loading-text="Загрузка..." class="btn btn-default"><i class="fa fa-upload"></i> Загрузить</button>';
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#payment-method').load('index.php?route=editors/catalog_edit/getPaymentMethod&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>');
				$('#shipping-method').load('index.php?route=editors/catalog_edit/getShippingMethod&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>');
