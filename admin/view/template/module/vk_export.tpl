              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select name="vk_export_market_photos_count" class="form-control">
                        ...
                        <option value="all" <?php echo $vk_export_market_photos_count == 'all' ? 'selected="selected"' : ''; ?>><?php echo $text_all ?></option>
                    </select>
                </div>
              </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="well well-sm" style="height: 150px; overflow: auto;">
                                      ...
                                      <div class="checkbox">
                                          <label>
                                            <?php if (in_array($category['category_id'], $vk_export_market_autoexport_category)) { ?>
                                            <input type="checkbox" name="vk_export_market_autoexport_category[]" value="<?php echo $category['category_id']; ?>" checked="checked" />
                                            <?php echo $category['name']; ?>
                                            <?php } else { ?>
                                            <input type="checkbox" name="vk_export_market_autoexport_category[]" value="<?php echo $category['category_id']; ?>" />
                                            <?php echo $category['name']; ?>
                                            <?php } ?>
                                          </label>
                                      </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="checkbox">
                                    ...
                                    <label><input type="radio" name="vk_export_market_cron_action_out_of_stock" value="not_avaible" <?php echo $vk_export_market_cron_action_out_of_stock == 'not_avaible' ? 'checked="checked"' : ''; ?> /> <?php echo $entry_status_not_avaible; ?></label><br><br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="checkbox">
                                    ...
                                    <label><input type="radio" name="vk_export_market_cron_action_disabled" value="not_avaible" <?php echo $vk_export_market_cron_action_disabled == 'not_avaible' ? 'checked="checked"' : ''; ?> /> <?php echo $entry_status_not_avaible; ?></label><br><br>
                                    <div class="help"><?php echo $entry_market_action_out_of_stock_desc ?></div>
                                </div>
                            </div>
                        </div>
