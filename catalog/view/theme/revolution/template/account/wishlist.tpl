        ...
        <tbody class="products_category">
          ...
          <tr class="product_<?php echo $product['product_id']; ?>">
            ...
            <td class="text-right"><?php if ($product['price']) { ?>
              ...
              <?php } ?></td>
            <td class="text-right wwicons">
			<a onclick="get_revpopup_cart('<?php echo $product['product_id']; ?>', 'catalog_mod'); yaCounter23924353.reachGoal('bookmark_basket');" data-toggle="tooltip" title="<?php echo $button_cart; ?>"><i class="fa fa-border fa-shopping-basket"></i></a>
