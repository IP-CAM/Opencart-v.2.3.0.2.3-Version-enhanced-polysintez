  ...
  <div class="page-header">
    <div class="container-fluid">
	  <div class="pull-right">
		...
		<a onclick="$('#form-filter').attr('action', '<?php echo $copy; ?>'); $('#form-filter').submit();" data-toggle="tooltip" title="<?php echo $button_copy; ?>" class="btn btn-warning"><i class="fa fa-copy"></i></a>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($filter['filter_group_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <?php if ($filter_name) { ?>
				    <td class="text-left"><a onclick="getName('<?php echo $filter['filter_group_id']; ?>');" data-toggle="popover-maxy" data-target="#filter-name-<?php echo $filter['filter_group_id']; ?>" data-placement="right right-top" id="filter-name<?php echo $filter['filter_group_id']; ?>" class="btn btn-link btn-sm"><?php echo $filter['name']; ?></a></td>
				    <?php } else { ?>
				    <td class="text-left"><?php echo $filter['name']; ?></td>
				  <?php } ?>
                  <?php if ($filter_sort_order) { ?>
				    <td class="text-right"><a data-toggle="popover-maxy" data-target="#filter-sort-<?php echo $filter['filter_group_id']; ?>" data-placement="left left-top" id="filter-sort<?php echo $filter['filter_group_id']; ?>" class="btn btn-default btn-sm"><?php echo $filter['sort_order']; ?></a></td>
                    <?php } else { ?>
					<td class="text-right"><?php echo $filter['sort_order']; ?></td>
                  <?php } ?>
                  <td class="text-center">
				    <?php if ($filter_value) { ?><a onclick="editFilterValue('<?php echo $filter['filter_group_id']; ?>');" data-toggle="tooltip" title="<?php echo $text_filter_value; ?>" class="btn btn-warning btn-sm"><i class="fa fa-star-o fa-fw"></i></a><?php } ?>
...
<?php foreach ($filters as $filter) { ?>
  <div id="filter-name-<?php echo $filter['filter_group_id']; ?>" class="popover popover-md popover-primary animate littleFadeInRight">
    <div class="arrow"></div>
  ...
  <div id="filter-sort-<?php echo $filter['filter_group_id']; ?>" class="popover popover-primary animate littleFadeInLeft">
    ...
    <div class="popover-content">
      <input type="number" name="sort_order" value="<?php echo $filter['sort_order']; ?>" placeholder="<?php echo $column_sort_order; ?>" id="input-sort<?php echo $filter['filter_group_id']; ?>" class="form-control" />
    </div>
