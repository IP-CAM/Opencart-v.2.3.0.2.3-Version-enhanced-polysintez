...
Вы успешно зарегистрировались в нашем интернет-магазине {store}.<br /><br />


Для входа в личный кабинет покупателя перейдите по ссылке:<br />
{account_link}<br /><br />
    ...
    <tbody>
      <tr>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;">
          ...
          Город: {city}<br />
          Адрес: {address_1} {address_2}
        </td>
      </tr>
    </tbody>
  </table>

Вы в любой момент можете изменить свои данные в личном кабинете.<br /><br />
