...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		if ($_SERVER['REQUEST_URI'] == '/contact-us/')
			$this->document->setDescription("Вы можете связаться со специалистами нашей компании с помощью формы обратной связи, а также написав письмо на почту market@polysintez.ru.");
