	...
	public function send($route, $output, $order_id, $order_status_id) {
		...
		if (in_array($order_info['order_status_id'], $this->config->get('config_complete_status'))) {
			...
			if ($voucher_query->num_rows) {
                ...
                //Shoputils.Mail.Order.Status Extension Begin
                //Send Mail to Admin
                $this->model_extension_module_shoputils_mail_order_status->voucherAdmin(array('voucher_info' => $voucher, 'order_info' => $order_info));
                //Send Mail to Affiliate
                if (!$this->model_extension_module_shoputils_mail_order_status->voucher(array('voucher_info' => $voucher, 'order_info' => $order_info))) {
                //Shoputils.Mail.Order.Status Extension End
