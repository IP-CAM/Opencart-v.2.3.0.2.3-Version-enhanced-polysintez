      ...
      <div class="panel-body">
                ...
                <div class="col-sm-3">
                  <div class="form-group">
                    <label class="control-label" for="input-manufacturer"><?php echo $column_producer; ?></label>
                      <input type="text" name="manufacturer" value="<?php echo $manufacturer ?>" placeholder="<?php echo $column_producer; ?>" id="input-manufacturer" class="form-control" />
        ...
        <form action="" method="post" enctype="multipart/form-data" id="form-product">
            ...
            <p class="text-right">
              ...
              <?php if ($show_column_albums) { ?>
                  <a id="export_action" class="btn btn-primary"><i class="fa fa-share"></i> Экспортировать в альбомы</a>
                  <a id="reexport_action" class="btn btn-danger"><i class="fa fa-remove"></i> Удалить из альбомов</a>
              <?php } ?>
               
              <?php if ($show_column_wall) { ?>
                  <a id="wallpost_action" class="btn btn-primary"><i class="fa fa-share"></i> Экспортировать на стену</a>
                  <a id="delete_wall_action" class="btn btn-danger"><i class="fa fa-remove"></i> Удалить со стены</a>
              <?php } ?>
              
              <?php if ($show_column_market) { ?>
                  <a id="market_action" class="btn btn-primary"><i class="fa fa-share"></i> Экспортировать в товары</a>
                  <a id="delete_market_action" class="btn btn-danger"><i class="fa fa-remove"></i> Удалить из товаров</a>
              <?php } ?>
            </p>
