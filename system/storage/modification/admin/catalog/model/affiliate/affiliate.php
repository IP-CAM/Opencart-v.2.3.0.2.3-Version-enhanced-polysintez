...
class ModelAffiliateAffiliate extends Model {
	public function addAffiliate($data) {
		...
		$message .= html_entity_decode($this->config->get('config_name'), ENT_QUOTES, 'UTF-8');
                ...
                if (!$this->model_extension_module_shoputils_mail_order_status->affiliateRegister(array('affiliate_id' => $affiliate_id, 'data' => $data))) {
		...
		$mail->send();
                ...
                //Send Mail to Admin
                if (!$this->model_extension_module_shoputils_mail_order_status->affiliateRegisterAdmin(array('affiliate_id' => $affiliate_id, 'data' => $data))) {
                //Shoputils.Mail.Order.Status Extension End
