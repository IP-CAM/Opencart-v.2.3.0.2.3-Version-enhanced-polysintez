...
<?php if( FALSE === strpos($_SERVER ['HTTP_USER_AGENT'],"Google Page Speed" ) ) { ?>
		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
		  <ul class="nav navbar-nav">
			...
			<?php if ($revtheme_header_links) { ?>
				...
				<?php } ?>
			<?php } ?>
			<li><a href="<?php echo $blog_link; ?>"><?php echo $text_oppro_blog; ?></a></li>
		  </ul>
		</div>
	</nav>
<div class="container"><?php echo $alphabetm; ?></div>
