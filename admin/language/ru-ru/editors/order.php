...
// Text
$_['text_success']               = 'Заказы успешно обновлены!';
...
$_['text_generate_invoice_no']   = 'Генерировать № счета';
...
$_['text_missings']              = '<span class="text-danger">Брошенный заказ</span>';
...
$_['text_customer_order']   	 = 'Данные покупателя в заказе';
$_['text_additional']   	 	 = 'Дополнительно';
$_['text_customer_orders']   	 = 'Все заказы покупателя';
$_['text_customer_mail']   	 	 = 'Написать покупателю';
...
$_['text_not_specified']    	 = 'Не указано';
...
// Help
$_['help_override']              = 'Применить аннулирование, если статус заказа был автоматически изменён одним из используемых методов борьбы с мошенничеством.';
...
$_['error_minimum']    			 = 'Минимальное количество товара %s  для заказа составляет %sшт.!';
