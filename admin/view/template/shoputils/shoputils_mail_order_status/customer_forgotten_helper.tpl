...
<table class="table table-bordered table-hover table-striped">
    ...
    <tr><td><span class="help">{reset_code}</span></td><td><span class="help left"><?php echo $text_reset_code_ft; ?></span></td></tr>
    <tr><td><span class="help">{reset_link}</span></td><td><span class="help left"><?php echo $text_reset_link_ft; ?></span></td></tr>
