...
class ModelAccountCustomer extends Model {
	public function addCustomer($data) {
		...
		$message .= html_entity_decode($this->config->get('config_name'), ENT_QUOTES, 'UTF-8');
                ...
                if (!$this->model_extension_module_shoputils_mail_order_status->customerRegister(array('customer_id' => $customer_id, 'data' => $data))) {
		...
		$mail->send();
                ...
                //Send Mail to Admin
                if (!$this->model_extension_module_shoputils_mail_order_status->customerRegisterAdmin(array('customer_id' => $customer_id, 'data' => $data))) {
                //Shoputils.Mail.Order.Status Extension End
